<template>
  <div class="data-show">
    ...
    <yc-card :style="{ width: '360px' }">
      ...
      <yc-card-meta title="Card Title" description="This is the description">
        <template #avatar>
          <div
...
import { IndicatorPosition, IndicatorType } from '@/components/Carousel';
const images = [
